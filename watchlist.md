...
| アカウント | 種別 | 備考 |
|-----------|------|------|
| ✅ @JaneStreetGroup | 機関 | MM・執行 (旧@JaneStreet) |
| ✅ @Citadel | 機関 | マルチ戦略 |
| ✅ @twosigma | 機関 | データ駆動・AI (旧@TwoSigma) |
...
| アカウント | 種別 | 備考 |
|-----------|------|------|
| ✅ @echanQT | 研究者/実務 | Ernie Chan / QTS・PredictNow / 著者 (旧@chanep) |
...
| ✅ @Skakinaka | 研究者 | Shinji Kakinaka 高知工科大 / マルチフラクタル配分 (旧@ShinjiKakinaka) |
